...
Le paramètre `styleVisualisation` spécifie l'URL du style de carte Mapbox à charger. Cela permet de personnaliser l'apparence visuelle du fond de carte affiché dans l'interface d'édition.
...
-   **Choisir un style pertinent** : Sélectionnez un style qui facilite votre travail d'édition.
