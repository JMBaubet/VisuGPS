...
4.  **Icônes et Actions rapides** :
    ...
    *   **Information et Vignette** <img src="https://api.iconify.design/mdi/information.svg?width=20" style="vertical-align: middle; margin-bottom: 3px;" title="Informations détaillées"> :   
      *Au survol de la souris* : Affiche la    **vignette** au survol de la souris
      *Au clic souris* : Ouvre les **informations** du circuit.
    *   **Éditer** <img src="https://api.iconify.design/mdi/pencil.svg?color=blue&width=20" style="vertical-align: middle; margin-bottom: 3px;" title="Ouvrir l'éditeur"> : Ouvre le mode Édition. 
    ...
    *   **Visualiser** <img src="https://api.iconify.design/mdi/eye.svg?color=green&width=20" style="vertical-align: middle; margin-bottom: 3px;" title="Lancer la visualisation 3D"> : Lance l'animation 3D. 
    ...
    <img src="https://api.iconify.design/mdi/eye.svg?color=green&width=20" style="vertical-align: middle; margin-bottom: 3px;"> Vert (terminé). (voir [Mode Visualisation](./visualisation.md))
